export default function DonatePage() {
  return (
    <div className="min-h-screen flex flex-col items-center mt-10 px-4">
      <h1 className="text-2xl sm:text-4xl font-bold mb-8">Donate to the Shelter</h1>
      ...
      <div className="grid w-full max-w-3xl gap-6 grid-cols-1">
        <a
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-4xl sm:text-6xl font-black tracking-tight">PayPal</div>
        ...
        <a
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-4xl sm:text-6xl font-black tracking-tight">Cash App</div>
            <div className="rounded-full border border-white/30 bg-white/10 px-6 py-3 text-lg font-semibold">
        ...
        <a
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-4xl sm:text-6xl font-black tracking-tight">Square</div>
            <div className="rounded-full border border-white/30 bg-white/10 px-6 py-3 text-lg font-semibold">
              Donate with Square
            </div>
          </div>
